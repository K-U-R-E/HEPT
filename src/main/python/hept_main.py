...
plt.savefig("./images/massliquidn20.png")

# Plot Mass Vapur N2O Curve
fig10 = plt.figure()
...
plt.savefig("./images/massvapourn20.png")
...
plt.plot(t,chamber_pressure[0:len(chamber_pressure)-1])
plt.savefig("./images/chamberpressure.png")
...
plt.savefig("./images/n2omassflowrate.png")
...
plt.savefig("./images/exhaustmassflowrate.png")
